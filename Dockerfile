...
RUN chmod +x $PYSETUP_PATH/scripts/install-build-packages.sh $PYSETUP_PATH/scripts/install-runtime-packages.sh
...
RUN $PYSETUP_PATH/scripts/install-runtime-packages.sh
WORKDIR $PYSETUP_PATH
