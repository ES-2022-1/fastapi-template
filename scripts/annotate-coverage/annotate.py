...
def _print_changed_files(changed_files: list):
    if changed_files:
        print("Changed files:")
...
class CheckRun:
    ...
    def create_annotations(self):
        ...
        if changed_files:
            coverage_files = self.coverage_output["files"].items()
            coverage_files = [
                (file_path, file_data)
                for file_path, file_data in coverage_files
            ...
            print("No changed files found. Skipping annotation creation.")
            quit()
    ...
    def get_summary(self):
        ...
        missing_coverage_file_count = sum(
            [
                True if len(self.coverage_output["files"][file_report]["missing_lines"]) else False
